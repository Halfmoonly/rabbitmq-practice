package org.lyflexi.custom_rabbit_framework.commonapi.interceptor;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import org.lyflexi.custom_rabbit_framework.commonapi.holder.LoginUserVo;
import org.lyflexi.custom_rabbit_framework.commonapi.holder.BizContextHolder;
...
public class UserInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        //解析出登录用户信息，并设置上下文
        BizContextHolder contextHolder = BizContextHolder.getInstance();
